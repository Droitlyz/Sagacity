...
function Library:CreateTabLabel(Properties, IsHud)
    local _Instance = Library:Create('TextLabel', {
        BackgroundTransparency = 1;
        Font = Enum.Font.Code;
        TextColor3 = Library.FontColor;
...
do
    ...
    function Funcs:AddColorPicker(Idx, Info)
        ...
        Library.ColorPickerDark = Library:GetDarkerColor(ColorPicker.Value);

        local DisplayFrame = Library:Create('Frame', {
            BackgroundColor3 = ColorPicker.Value;
            BorderColor3 = Library.ColorPickerDark;
        ...
        local HueBoxOuter = Library:Create('Frame', {
            BorderColor3 = Library.OutlineColor;
            Position = UDim2.fromOffset(4, 212),
        ...
        local RgbBoxBase = Library:Create(HueBoxOuter:Clone(), {
            Position = UDim2.new(0.5, 2, 0, 212),
            Size = UDim2.new(0.5, -6, 0, 20),
            Parent = PickerFrameInner
        });  
        ...
        Library:AddToRegistry(PickerFrameInner, { BackgroundColor3 = 'BackgroundColor'; BorderColor3 = 'InlineColor'; });
        Library:AddToRegistry(Highlight, { BackgroundColor3 = 'AccentColor'; });
        Library:AddToRegistry(SatVibMapInner, { BackgroundColor3 = 'BackgroundColor'; BorderColor3 = 'InlineColor'; });

        Library:AddToRegistry(HueBoxInner, { BackgroundColor3 = 'MainColor'; BorderColor3 = 'InlineColor'; });
        Library:AddToRegistry(RgbBoxBase.Frame, { BackgroundColor3 = 'MainColor'; BorderColor3 = 'InlineColor'; });
    ...
    function Funcs:AddColorPickerForSettings(Idx, Info)
        local ToggleLabel = self.TextLabel;
        local Container = self.Container;
    ...
    function Funcs:AddKeyPickerForSettings(Idx, Info)
        local ParentObj = self;
        local ToggleLabel = self.TextLabel;
        local Container = self.Container;
...
do
    ...
    function Funcs:AddBlankForSettings(Size)
        local Groupbox = self;
        local Container = Groupbox.Container;
    ...
    function Funcs:AddLabelForSettings(Text)
        local Label = {};
    ...
    function Funcs:AddButton(Text, Func)
        ...
        function Button:AddButton(Text, Func)
            ...
            ButtonOuter.Size = UDim2.new(0.5, -2, 0.004, 20)
    ...
    function Funcs:AddButtonForSettings(Text, Func)
        local Button = {};
    ...
    function Funcs:AddDividerForSettings()
        local Groupbox = self;
        local Container = self.Container
    ...
    function Funcs:AddInputForSettings(Idx, Info)
        local Textbox = {
            Value = Info.Default or '';
            Numeric = Info.Numeric or false;
            Finished = Info.Finished or false;
    ...
    function Funcs:AddToggleForSettings(Idx, Info)
        local Toggle = {
            Value = Info.Default or false;
            Type = 'Toggle';
    ...
    function Funcs:AddSliderForSettings(Idx, Info)
        assert(Info.Default and Info.Text and Info.Min and Info.Max and Info.Rounding, 'Bad Slider Data');
    ...
    function Funcs:AddDropdownForSettings(Idx, Info)
        assert(Info.Text and Info.Values, 'Bad Dropdown Data');
...
function Library:SetWatermark(Text)
    ...
    Library.Watermark.Size = UDim2.new(0, X + 12, 0, 20);
...
function Library:Notify(Text, Time)
    ...
    Library.Notifications = NotifyOuter;
    
function Library:SetNotificationsVisibility(Bool)
    Library.Notifications.Visible = Bool;
end;
...
function Library:CreateWindow(...)
    ...
    function Window:AddTab(Name)
        ...
        local TabButtonLabel = Library:CreateTabLabel({
            Position = UDim2.new(0, 0, 0, 0);
        ...
        function Tab:AddGroupboxForSettings(Info)
            local Groupbox = {};
